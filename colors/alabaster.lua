...
if vim.o.background == "dark" then
    ...
    theme = {
        ...
        MatchParen = { bg = ansi.black, fg = fg },
        ...
        TSFunction = { fg = ansi.brightyellow },
        TSFuncBuiltin = { fg = ansi.white },
        TSFuncMacro = { fg = ansi.white },
        TSKeyword = { fg = punct_fg },
        TSKeywordFunction = { fg = ansi.brightyellow },
        TSKeywordReturn = { fg = ansi.brightyellow },
        ...
        ["@keyword"] = { fg = punct_fg },
        ["@keyword.function"] = { fg = ansi.brightyellow },
        ["@keyword.return"] = { fg = ansi.brightyellow },
        ["@label"] = { fg = ansi.white },
